    ...
    public class ViewFactory : IViewFactory
    {
        ...
        public MessageOptionsPopup CreateMessageOptionsPopup(MessageView messageView, IChatState state)
        {
            ...
            else
            {
                ...
                //ErmisTodo: muted ? => show unmute instead
            ...
            where TPopup : BaseFullscreenPopup
        {
            ...
            //ErmisTodo: fix this dependency, some popups don't need view context like ErrorPopup
        ...
        private void AddReactionsEmojiOptions(ICollection<EmojiOptionEntry> emojis, IErmisMessage message)
        {
