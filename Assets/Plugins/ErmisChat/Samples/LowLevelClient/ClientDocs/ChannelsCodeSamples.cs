...
namespace ErmisChat.Samples.LowLevelClient.ClientDocs
{
    ...
    public class ChannelsCodeSamples
    {
        ...
        private async void CreatingChannelForListOfMembers()
        {
            ...
            {
                ChannelInfo = new CreateChannelInfo
                {
            ...
            var channelState = await _lowLevelClient.ChannelApi.CreateChannelAsync(channelType: "messaging", requestBody);
        }
        ...
        private async Task WatcherCount()
        {
            ...
            {
                var watcherCount = channelState.Watchers.Count;
            }
        }
        ...
        public void GetInitialLocalUserReadState()
        {
            ...
            void InitErmisChatClient()
            {
                _lowLevelClient = ErmisChatLowLevelClient.CreateDefaultClient(authCredentials);
        ...
        public async Task MarkAllAsRead()
        {
            ...
            var markReadResponse = await _lowLevelClient.ChannelApi.MarkReadAsync("messaging", "channel-id");
        }
        ...
        private async Task AddMember()
        {
            ...
            //Make API call
            var response = await _lowLevelClient.ChannelApi.UpdateChannelAddMembersAsync(channelState.Channel.Type,
                channelState.Channel.Id,
