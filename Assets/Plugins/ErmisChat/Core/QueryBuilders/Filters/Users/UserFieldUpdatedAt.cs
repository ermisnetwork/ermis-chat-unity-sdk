...
{
    /// <summary>
    /// Filter by <see cref="IErmisUser.UpdatedAt"/>
    /// </summary>
    public sealed class UserFieldUpdatedAt : BaseFieldToFilter
    {
        ...
        /// <summary>
        /// Return only users where <see cref="IErmisUser.UpdatedAt"/> is EQUAL to the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only users where <see cref="IErmisUser.UpdatedAt"/> is GREATER THAN the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only users where <see cref="IErmisUser.UpdatedAt"/> is GREATER THAN OR EQUAL to the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only users where <see cref="IErmisUser.UpdatedAt"/> is LESS THAN the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only users where <see cref="IErmisUser.UpdatedAt"/> is LESS THAN OR EQUAL to the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only users where <see cref="IErmisUser.UpdatedAt"/> is EQUAL to ANY of provided user Id
        /// </summary>
