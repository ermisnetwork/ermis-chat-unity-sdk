...
namespace ErmisChat.SampleProject.Views
{
    ...
    public class MessageListView : BaseView
    {
        ...
        private void OnActiveChannelChanged(IErmisChannel channel)
        {
        ...
        private void RebuildMessages(IErmisChannel channel, bool scrollToBottom)
        {
            ClearAll();
        ...
        //ErmisTodo: extract to ViewFactory
        private MessageView CreateMessageView(IErmisMessage message)
        {
