...
{
    /// <summary>
    /// Fields that you can use to sort <see cref="IErmisUser"/> query results when using <see cref="IErmisChatClient.QueryUsersAsync"/>
    /// </summary>
    public readonly struct UserSortField
    {
        ...
        /// <summary>
        /// Sort by your custom field of <see cref="IErmisUser"/>
        /// </summary>
