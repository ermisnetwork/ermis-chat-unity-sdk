...
{
    /// <summary>
    /// Cache repository for <see cref="IErmisStatefulModel"/>
    /// </summary>
        ...
        where TStatefulModel : class, IErmisStatefulModel
    {
        ...
        public void RegisterDtoIdMapping<TType, TDto>(Func<TDto, string> idGetter)
            where TType : class, TStatefulModel, IErmisStatefulModel, IUpdateableFrom<TDto, TType>
            where TDto : class
        {
            var key = typeof(TDto);
        ...
        /// <summary>
        /// This is called from <see cref="IErmisStatefulModel"/> constructor
        /// </summary>
        ...
        public void Remove(TStatefulModel trackedObject)
        {
            ...
            //ErmisTodo: we could notify object that its being removed, perhaps IDIsposable?
