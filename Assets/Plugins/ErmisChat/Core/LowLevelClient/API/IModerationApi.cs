...
namespace Ermis.Core.LowLevelClient.API
{
    ...
    //    Task<UnmuteResponse> UnmuteUserAsync(UnmuteUserRequest unmuteUserRequest);
        ...
        /// message.flagged webhook event and adds the message to the inbox of your Ermis Dashboard Chat Moderation view.
        ...
        /// If you prefer to build your own in app moderation dashboard, rather than use the Ermis
        /// dashboard, then the query message flags endpoint lets you get flagged messages. Similar
        /// to other queries in Ermis Chat, you can filter the flags using query operators.
        /// </summary>
