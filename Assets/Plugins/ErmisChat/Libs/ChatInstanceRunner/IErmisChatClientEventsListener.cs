...
{
    /// <summary>
    /// Ermis Chat Client requires Environment to call <see cref="Update"/> per frame and <see cref="Destroy"/> when application is destroyed
    /// E.g. in Unity Engine a wrapping MonoBehaviour would call them when receiving Update and OnDestroy callbacks respectively
    /// </summary>
    public interface IErmisChatClientEventsListener
    {
        /// <summary>
        ...
        /// <summary>
        /// Call per application frame update. Calling Update every frame is critical for Ermis Chat Client to work properly
