...
{
    /// <summary>
    /// Filter by <see cref="IErmisUser.CreatedAt"/>
    /// </summary>
    public sealed class UserFieldCreatedAt : BaseFieldToFilter
    {
        ...
        /// <summary>
        /// Return only users where <see cref="IErmisUser.CreatedAt"/> is EQUAL to the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only users where <see cref="IErmisUser.CreatedAt"/> is GREATER THAN the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only users where <see cref="IErmisUser.CreatedAt"/> is GREATER THAN OR EQUAL to the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only users where <see cref="IErmisUser.CreatedAt"/> is LESS THAN the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only users where <see cref="IErmisUser.CreatedAt"/> is LESS THAN OR EQUAL to the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only users where <see cref="IErmisUser.CreatedAt"/> is EQUAL to ANY of provided user Id
        /// </summary>
