...
namespace Ermis.Core.LowLevelClient.Models
{
        ...
        ILoadableFrom<MessageResponseInternalDTO, Message>
    {
        ...
        //ErmisTodo: should we remove this? field summary says it's only available in a webhook
        /// <summary>
        ...
        Message ILoadableFrom<MessageInternalDTO, Message>.LoadFromDto(MessageInternalDTO dto)
        {
            ...
            PinnedBy = PinnedBy.TryLoadFromDto<UserIdObjectInternalDTO, User>(dto.PinnedBy);
