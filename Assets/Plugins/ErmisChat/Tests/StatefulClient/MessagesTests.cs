...
{
    /// <summary>
    /// Tests operations executed on <see cref="ErmisMessage"/>
    /// </summary>
    internal class MessagesTests : BaseStateIntegrationTests
    {
        ...
        private async Task When_send_message_with_custom_data_expect_custom_data_on_message_Async()
        {
            ...
            var sentMessage = await channel.SendNewMessageAsync(new ErmisSendMessageRequest
            {
                Text = MessageText,
        ...
        private async Task When_Update_message_expect_message_changed_Async()
        {
            ...
            // ErmisTodo: Test all properties like pinned, attachments, mentions, Html, Mml, etc.
            await messageInChannel.UpdateAsync(new ErmisUpdateMessageRequest
            {
        ...
        private async Task when_search_for_mentioned_messages_expect_valid_results_Async()
        {
            ...
            var messageWithMention = await channel.SendNewMessageAsync(new ErmisSendMessageRequest
            {
                Text = "You doing? ",
            ...
            //ErmisTodo: implement with stateful client
