...
namespace Ermis.Core.LowLevelClient
{
    ...
    internal class ReconnectScheduler : IDisposable
    {
        ...
        public int ReconnectMaxInstantTrials { get; private set; } = 5; //ErmisTodo: allow to control this by user
        ...
        public ReconnectScheduler(ITimeService timeService, IErmisChatLowLevelClient lowLevelClient,
        ...
        //ErmisTodo: connection info could be split to separate interface
        private readonly IErmisChatLowLevelClient _client;
