...
namespace ErmisChat.EditorTools.CommandLineParsers
{
    public class
        ...
        authCredentials)>
    {
        ...
        public const string ErmisBase64TestDataArgKey = "-ermisBase64TestDataSet";
            ...
            IDictionary<string, string> args)
        {
            if (IsAnyRequiredArgMissing(args, out var missingArgsInfo, BuildTargetPlatformArgKey,
                    ApiCompatibilityArgKey, ScriptingBackendArgKey, BuildTargetPathArgKey, ErmisBase64TestDataArgKey))
            {
        ...
        {
            if (!args.ContainsKey(ErmisBase64TestDataArgKey))
            {
                throw new ArgumentException($"Tests CLI - Missing argument: `{ErmisBase64TestDataArgKey}`");
            }
            ...
            var base64TestAuthDataSet = args[ErmisBase64TestDataArgKey];
