...
namespace ErmisChat.Tests.LowLevelClient.Integration
{
    ...
    internal class ChannelApiIntegrationTests : BaseIntegrationTests
    {
        ...
        //[UnityTest] ErmisTodo: re-enable this test once Watchers issue is resolved
        ...
        public IEnumerator When_deleting_non_existing_channel_expect_fail()
        {
            ...
            {
                Assert.AreEqual(((ErmisApiException)exception).StatusCode, 404);
            });
        }
        ...
        public IEnumerator Partial_update()
        {
            ...
            yield return getOrCreateTask2.RunAsIEnumerator(response =>
            {
                ...
                //ErmisTodo: add support - this array is Newtonsoft.Json.Linq.JArray
        ...
        //[UnityTest] //ErmisTodo: temporarily disable due to failing test. Requires investigation
