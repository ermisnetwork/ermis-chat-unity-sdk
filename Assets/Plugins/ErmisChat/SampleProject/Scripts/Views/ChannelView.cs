...
namespace ErmisChat.SampleProject.Views
{
    ...
    {
        public event Action<IErmisChannel> Clicked;

        public void Init(IErmisChannel channel, IChatViewContext context)
        {
        ...
        private IErmisChannel _channel;
        ...
        private void UpdateMessagePreview()
        {
            ...
            //ErmisTodo: this breaks when instead of a regular character we have an emoji
        ...
        private void OnActiveChanelChanged(IErmisChannel channel)
        {
