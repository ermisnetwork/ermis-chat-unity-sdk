...
{
    /// <summary>
    /// Filter by <see cref="IErmisUser.LastActive"/>
    /// </summary>
    public sealed class UserFieldLastActive : BaseFieldToFilter
    {
        ...
        /// <summary>
        /// Return only users where <see cref="IErmisUser.LastActive"/> is EQUAL to the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only users where <see cref="IErmisUser.LastActive"/> is GREATER THAN the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only users where <see cref="IErmisUser.LastActive"/> is GREATER THAN OR EQUAL to the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only users where <see cref="IErmisUser.LastActive"/> is LESS THAN the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only users where <see cref="IErmisUser.LastActive"/> is LESS THAN OR EQUAL to the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only users where <see cref="IErmisUser.LastActive"/> is EQUAL to ANY of provided user Id
        /// </summary>
