...
namespace ErmisChat.Tests.LowLevelClient.Api
{
    ...
    internal class MessageApiTests
    {
        ...
        public void Up()
        {
            ...
            _lowLevelClient = new ErmisChatLowLevelClient(_authCredentials, _mockWebsocketClient, _mockHttpClient, _serializer,
                _mockTimeService, _mockNetworkMonitor, _mockApplicationInfo, _mockLogs, _mockErmisClientConfig);
        }
        ...
        private static readonly string NameBase = $"{nameof(IErmisChatLowLevelClient)} - {nameof(IMessageApi)}";
        ...
        private class SendReactionTestCase : EndpointTestCaseBase
        {
            ...
            public override void ExecuteRequest(IErmisChatLowLevelClient lowLevelClient)
            {
