...
{
    /// <summary>
    /// Filter by <see cref="IErmisChannel.CreatedAt"/>
    /// </summary>
    public sealed class ChannelFieldCreatedAt : BaseFieldToFilter
    {
        ...
        /// <summary>
        /// Return only channels where <see cref="IErmisChannel.CreatedAt"/> is EQUAL to the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only channels where <see cref="IErmisChannel.CreatedAt"/> is GREATER THAN the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only channels where <see cref="IErmisChannel.CreatedAt"/> is GREATER THAN OR EQUAL to the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only channels where <see cref="IErmisChannel.CreatedAt"/> is LESS THAN the provided one
        /// </summary>
        ...
        /// <summary>
        /// Return only channels where <see cref="IErmisChannel.CreatedAt"/> is LESS THAN OR EQUAL to the provided one
        /// </summary>
