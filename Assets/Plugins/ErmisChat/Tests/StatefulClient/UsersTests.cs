...
{
    /// <summary>
    /// Tests operations executed on <see cref="IErmisUser"/>
    /// </summary>
    internal class UsersTests : BaseStateIntegrationTests
    {
        ...
        private async Task When_upsert_user_expect_valid_user_returned_Async()
        {
            ...
            var createNewUserRequest = new ErmisUserUpsertRequest
            {
                Id = userId,
                Role = "user",
                Name = "David",
        ...
        private async Task When_query_banned_users_expect_valid_results_Async()
        {
            ...
            var bannedUsers = (await Client.QueryBannedUsersAsync(new ErmisQueryBannedUsersRequest()
            {
        ...
        private async Task When_query_users_with_id_autocomplete_expect_valid_results_Async()
        {
            ...
            var filters = new IFieldFilterRule[]
            {
                ...
                //ErmisTodo: uncomment when created_at issue is resolved
