...
namespace Ermis.Libs.Websockets
{
    /// <summary>
    ...
    public class WebsocketClient : IWebsocketClient
    {
        ...
        private async Task TryCloseAndDisposeAsync(WebSocketCloseStatus closeStatus, string closeMessage)
        {
            ...
            try
            {
                ...
                {
#if ERMIS_DEBUG_ENABLED || ERMIS_TESTS_ENABLED
...
#endif
                    // ErmisTodo. This can throw " InvalidOperationException: This operation is only allowed using a successfully authenticated context."
