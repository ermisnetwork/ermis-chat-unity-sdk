...
namespace ErmisChat.Samples.LowLevelClient.ClientDocs
{
    ...
    public class MessagesApiCodeSamples
    {
        ...
        {
            //await _lowLevelClient.MessageApi.UpdateMessageAsync(_lowLevelClient. new UpdateMessageRequest
            //{
            //    Message = new MessageUpdateRequest
            //    {
        ...
        public async Task DeleteFile()
        {
            ...
            var remoteFileUrl = "url/to/file/in/ermis/cdn";
